...
REVIEWED_VERIFIED = {
    "Marlow-Hunter", "Pacific Seacraft",
    "Performance Cruising (Gemini Catamarans)", "MacGregor Yacht Corporation",
    "Alerion Yachts", "Morgan Yachts", "Ericson Yachts", "Islander Yachts",
    "Moody", "Marine Projects (Plymouth) Ltd", "Sadler Yachts", "Rustler Yachts",
    "Bowman Yachts", "Northshore Yachts", "Southerly", "Discovery Yachts",
    "Cornish Crabbers", "Fountaine Pajot", "Lagoon",
    "CNB (Construction Navale Bordeaux)", "Wauquiez",
    "Gibert Marine (Gib'Sea)", "Kelt (Kelt Marine)", "Kirié (Feeling brand)",
    "Fora Marine (RM Yachts)", "ETAP Yachting", "Victoire Jachtbouw",
    "AD Boats d.o.o. (Salona Yachts)", "Delphia Yachts",
    "Ostróda Yacht Sp. z o.o.", "Antila Yachts",
    "Northman (Maxus Yachts brand)", "Balt-Yacht",
    "Schöchl Yachtbau (Sunbeam Watersports GmbH)", "AVAR-YACHT, s.r.o.",
    "Najad Yachts", "Maxi Yachts", "Nauticat Yachts", "Finngulf Yachts",
    "Oy Fiskars Ab Boatyard (Finnsailer)", "Bringsværd Boat Yard",
    "Fjord Plast AS",
}
...
BRAND_CONTEXT_ONLY = {
    "J/Boats", "Freedom Yachts", "Alerion Yachts", "Moody",
    "Bowman Yachts", "Southerly", "Lagoon", "Maxi Yachts",
}
...
KIND_PATCH = {
    ...
    "Schöchl Yachtbau (Sunbeam Watersports GmbH)": [
        "manufacturer", "yard", "legal_organization"
    ],
...
NEW = [
    ("Cantiere del Pardo", ["Grand Soleil"], ["manufacturer","yard"], "Italy", "Southern Europe", "active", 1973, None, "exact",
     "https://cantieredelpardo.com/", "https://cantieredelpardo.com/it/the-yard/our-heritage/",
     ["https://cantieredelpardo.com/company/our-values/","https://cantieredelpardo.com/it/the-yard/our-heritage/"],
     5000, "estimated", "Company material states more than 5,000 boats launched; GS34 alone 290.", None),
    ("Comar Yachts / Sipla", ["Comar Yachts","Sipla","Comet"], ["manufacturer","yard"], "Italy", "Southern Europe", "active", 1961, None, "exact",
     "https://www.comaryachts.it/en/history/", "https://www.comaryachts.it/en/history/",
     ["https://www.comaryachts.it/en/history/"], 5000, "estimated",
     "Official history gives several-thousand cumulative output; Comet 910 alone approached 1,000.", None),
    ("Solaris Yachts", [], ["manufacturer","yard"], "Italy", "Southern Europe", "active", 1974, None, "exact",
     "https://www.solarisyachts.com/", "https://www.solarisyachts.com/en/milestones/",
     ["https://www.solarisyachts.com/en/milestones/"], None, "unknown", "Current/historical repeated model series verified.", None),
    ("Alpa", [], ["manufacturer","yard"], "Italy", "Southern Europe", "defunct", 1956, 1979, "estimated",
     None, "https://www.alpahistorical.org/storia-del-cantiere.html",
     ["https://www.alpahistorical.org/storia-del-cantiere.html"], None, "unknown", "Historical repeated production verified.", None),
    ("Cantiere Zuanelli", [], ["manufacturer","yard"], "Italy", "Southern Europe", "active", 1972, None, "exact",
     "https://zuanelli.it/", "https://zuanelli.it/chi-siamo/",
     ["https://zuanelli.it/chi-siamo/"], None, "unknown", "Repeated cruising-yacht model line verified.", None),
    ("Italia Yachts", [], ["manufacturer","yard"], "Italy", "Southern Europe", "active", 2011, None, "exact",
     "https://www.italiayachtsinternational.com/", "https://www.italiayachtsinternational.com/en_en/azienda/cantiere/",
     ["https://www.italiayachtsinternational.com/en_en/azienda/cantiere/"], None, "unknown", "Current repeated performance-cruiser production verified.", None),
    ("North Wind Yachts", [], ["manufacturer","yard"], "Spain", "Southern Europe", "historical", 1973, None, "estimated",
     None, None, ["https://www.devalk.nl/en/yachtbrokerage/252093/NORTH-WIND-47.html","https://barcosnautica.com/en/embarcaciones/north-wind-47"],
     None, "unknown", "Historical repeated cruising-yacht production verified.", "Current corporate continuity remains unknown."),
    ("Belliure", [], ["manufacturer","yard"], "Spain", "Southern Europe", "defunct", 1953, 2017, "exact",
     "https://www.belliure.com/", "https://www.belliure.com/pa-historia-536-441.html",
     ["https://www.belliure.com/pa-historia-536-441.html","https://www.belliure.com/pa-belliure-35-endurance-536-719-es.html"],
     170, "estimated", "Official history states more than 170 GRP boats; Endurance 35 reached 160 units.", None),

    ("Cheoy Lee Shipyards", [], ["manufacturer","yard"], "Hong Kong", "Asia-Pacific", "active", 1957, 1990, "estimated",
     "https://cheoylee.com/", "https://cheoylee.com/heritage/", ["https://cheoylee.com/heritage/"],
     None, "unknown", "Historic production-yacht output verified; Lion 35 alone exceeded 90 across wood and GRP.", "Company remains active; qualifying sailboat production is historical and current construction is centered in Zhuhai, China."),
    ("Ta Yang Yacht Building Co., Ltd.", ["Tayana"], ["manufacturer","yard"], "Taiwan", "Asia-Pacific", "defunct", 1972, 2020, "exact",
     None, None, ["https://findcompany.com.tw/TA%20YANG%20YACHT%20BUILDING%20CO.%2C%20LTD."],
     1400, "estimated", "Industry sources report more than 1,400 Ta Yang/Tayana cruisers.", None),
    ("Ta Shing Yacht Building", [], ["manufacturer","yard"], "Taiwan", "Asia-Pacific", "active", None, None, "unknown",
     None, None, ["https://findbiz.nat.gov.tw/fts/company/69559634?fhl=en"],
     None, "unknown", "Extensive repeated OEM and own-line sailboat construction verified.", None),
    ("Queen Long Marine", ["Hylas"], ["manufacturer","yard"], "Taiwan", "Asia-Pacific", "active", None, None, "unknown",
     "https://www.hylasyachts.com/about/", None, ["https://www.hylasyachts.com/about/"],
     None, "unknown", "Current repeated Hylas production verified.", None),
    ("New Japan Yacht", [], ["manufacturer","yard"], "Japan", "Asia-Pacific", "active", 1969, None, "exact",
     "https://www.njy.co.jp/", None, ["https://www.njy.co.jp/company/"],
     800, "estimated", "Company states more than 800 yachts built.", None),
    ("Yamaha Motor marine yacht activity", [], ["manufacturer"], "Japan", "Asia-Pacific", "historical", 1970, 1990, "estimated",
     "https://www.yamaha-motor.co.jp/marine/history/products-history/1970/", None,
     ["https://www.yamaha-motor.co.jp/marine/history/products-history/1970/"],
     None, "unknown", "Broad multi-model historical production series verified.", None),
    ("Fuji Yacht Builders", [], ["manufacturer","yard"], "Japan", "Asia-Pacific", "historical", None, None, "unknown",
     None, None, ["https://www.fujiyachts.net/history/history.html"],
     200, "estimated", "Historical sources report more than 200 boats across the Fuji series.", None),
    ("Far East Yachts / Far East Boat Ltd.", [], ["manufacturer","yard"], "Japan", "Asia-Pacific", "historical", 1958, 1971, "estimated",
     None, None, ["https://www.fujiyachts.net/history/takao.html"],
     None, "unknown", "Historical repeated Mariner-series production verified.", None),

    ("McConaghy Boats", [], ["manufacturer","yard"], "Australia", "Asia-Pacific", "active", 1967, None, "exact",
     "https://mcconaghyboats.com/", "https://mcconaghyboats.com/our-story/",
     ["https://mcconaghyboats.com/our-story/","https://mcconaghyboats.com/facilities/"],
     150, "estimated", "Company states a fleet of more than 150 yachts 30 ft and above, excluding many smaller series.", None),
    ("Bashford Boats / Bashford International", ["Sydney Yachts"], ["manufacturer","yard"], "Australia", "Asia-Pacific", "historical", 1980, 2013, "estimated",
     None, None, ["https://www.sydneyyachts.com/company/sydney-yachts.html"],
     None, "unknown", "Repeated J/Boat, Etchells and Sydney production programs verified.", "Post-2013 Sydney Yachts production transferred to AD Boats in Croatia."),
    ("Seawind Catamarans", [], ["manufacturer","yard","brand"], "Australia", "Asia-Pacific", "active", 1982, None, "exact",
     "https://www.seawindcats.com/", "https://www.seawindcats.com/about-us/",
     ["https://www.seawindcats.com/about-us/","https://www.seawindcats.com/blog/seawind-catamarans-40-years-of-sailing-excellence/"],
     350, "estimated", "Seawind 24 alone exceeded 350 hulls.", "Current primary production is in Vietnam with additional production in Türkiye."),
    ("Robertson & Caine", [], ["manufacturer","yard"], "South Africa", "Rest of World", "active", 1991, None, "exact",
     "https://www.robertsonandcaine.com/", None,
     ["https://www.robertsonandcaine.com/overview.html","https://www.robertsonandcaine.com/achievements.html"],
     3132, "estimated", "Official achievements page reports more than 3,132 catamarans through April 2026.", None),
    ("St Francis Marine", [], ["manufacturer","yard"], "South Africa", "Rest of World", "active", 1988, None, "exact",
     "https://stfranciscatamarans.com/", "https://www.stfranciscatamarans.com/our-history",
     ["https://stfranciscatamarans.com/","https://www.stfranciscatamarans.com/our-history"],
     120, "estimated", "Official site states more than 120 boats built.", None),
    ("Knysna Yacht Company", [], ["manufacturer","yard"], "South Africa", "Rest of World", "active", 2002, None, "exact",
     "https://www.knysnayachtco.com/", None, ["https://www.knysnayachtco.com/about-knysna-yacht-company/"],
     100, "estimated", "Current company material states more than 100 builds.", None),
    ("VOYAGE Yachts", [], ["manufacturer","yard"], "South Africa", "Rest of World", "active", 1994, None, "exact",
     "https://www.voyageyachts.com/", None, ["https://www.voyageyachts.com/about-us"],
     150, "estimated", "Industry material reports well over 150 catamarans historically.", None),
    ("Cavalier Yachts", [], ["manufacturer","yard"], "New Zealand", "Asia-Pacific", "historical", 1970, 1979, "estimated",
     None, None, ["https://www.petersmith.net.nz/about/peter.php","https://cav36.com/"],
     None, "unknown", "Multiple repeated production series verified; no normalized lifetime total.", None),
]

RECORD_FIELDS = {
    "preferred_display_name", "aliases", "entity_kind", "country", "region",
    "status", "production_era", "relationships", "series_production_evidence",
    "official_current_site", "official_heritage_archive", "other_archive_sources",
    "sources", "rights_assessment", "model_yield_estimate", "ambiguity_notes",
}
...
def normalize_raw(raw: dict, rid: str) -> dict:
    ...
    rec.setdefault("model_yield_estimate", {"value": None, "basis": "unknown", "notes": "No normalized yield retained."})
    return rec


def make_new(row: tuple, rid: str, packet: str) -> dict:
    (
        name, aliases, kinds, country, region, status, start, end, basis,
        site, heritage, urls, yield_value, yield_basis, yield_notes, ambiguity,
    ) = row
    sources = [
        {"url": u, "title": f"Source for {name}", "source_type": "other", "retrieved_at": STAMP}
        for u in urls
    ]
    sources.append({"url": packet, "title": "Independent SLICE-0019 research batch", "source_type": "other", "retrieved_at": STAMP})
    rights = [
        {
            "source_url": u,
...
def build() -> dict:
    ...
    packet_by_index = (
        ["repo://research/manufacturers/new_research_batches/RESEARCH-007-southern-europe-core.md"] * 8
        + ["repo://research/manufacturers/new_research_batches/RESEARCH-008-asia-core-yards.md"] * 8
        + ["repo://research/manufacturers/new_research_batches/RESEARCH-009-australia-new-zealand-south-africa.md"] * 8
    )
...
def validate(registry: dict) -> None:
    ...
    floor = [
        ...
        and {"manufacturer", "yard"} & set(r["entity_kind"])
    ]
    assert len(floor) == 121, len(floor)

    context = {
        r["preferred_display_name"] for r in records
        if r["research_status"] == "verified"
    ...
    recognized_types = {
        "official_heritage_archive", "designer_archive",
        "class_or_owners_association", "museum_or_archive",
    }
    archives = sum(
        bool(r["official_heritage_archive"])
        or any(s["source_type"] in recognized_types for s in r["sources"])
        for r in records if r["research_status"] == "verified"
    )
