...
SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "model_identities": [
            {
                "model_name": "Elan 31",
                "source_surface": "https://www.elan-yachts.com/en/carbon/history",
                "discriminating_context": f"{_MONOHULL}; no additional generation/variant marker beyond model number as presented; sourced from official History page",
            },
            {
                "model_name": "Elan 33",
                "source_surface": "https://www.elan-yachts.com/en/carbon/history",
            ...
            },
            {
                ...
                "source_surface": "https://www.elan-yachts.com/en/carbon/history",
                "discriminating_context": f"{_MONOHULL}; explicit variant marker 'Performance' as presented; sourced from official History page",
            },
            {
                "model_name": "Elan 333",
                "source_surface": "https://www.elan-yachts.com/en/carbon/history",
            ...
            },
            {
                ...
                "source_surface": "https://www.elan-yachts.com/en/carbon/history",
                "discriminating_context": f"{_MONOHULL}; distinct sub-line name 'Impression' rather than 'Elan' prefix, as presented; sourced from official History page",
            },
            {
                "model_name": "Elan 350",
                "source_surface": "https://www.elan-yachts.com/en/carbon/history",
            ...
            },
            {
                ...
                "discriminating_context": f"{_MONOHULL}; presented on the official 'Previous Models' surface, carrying the explicit 'E3' model designation",
            },
        ],
    },
    {
        ...
        "model_identities": [
            {
                ...
                "source_surface": "https://oldshop.hallberg-rassy.com/contents/en-us/d291_Hallberg-Rassy-Elvstrom-Zippack-System.html",
                "discriminating_context": f"{_MONOHULL}; listed on the official Hallberg-Rassy Parts surface alongside the other retained pilot models; no additional generation marker",
            },
            {
