# HullQ Identity Model v0.1 — DRAFT

**Status:** PROPOSED  
**Blocks:** REQ-ID-003 / OQ-003  
...
## 5. Builder/designer relationships
...
## 8. Search semantics consequence
...
## 11. Migration from BoatDesign schema v0.2

`verified_identity.variant` is insufficient and MUST NOT become the long-term identity model.

After OQ-003 acceptance, the next BoatDesign schema revision SHOULD:
...
- leave provenance persistence mechanics to OQ-004.

Schema v0.2 remains a draft/reference contract until superseded.

## 12. Acceptance criteria

OQ-003 can be marked DECIDED when all are true:
