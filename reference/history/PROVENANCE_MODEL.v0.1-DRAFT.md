# HullQ Provenance Model v0.1 — DRAFT

**Status:** DRAFT / READY_FOR_DECISION  
**Decision:** OQ-004 / proposed ADR-0006  
...
This draft is represented by:

- `specs/FIELD_EVIDENCE_SCHEMA.v0.1-DRAFT.json`;
- `specs/FIELD_RESOLUTION_SCHEMA.v0.1-DRAFT.json`;
- `specs/DERIVATION_RECORD_SCHEMA.v0.1-DRAFT.json`;
- `fixtures/provenance/`.

## 16. Proposed semantic validation rules

These IDs are part of the OQ-004 proposal and become active only if OQ-004 is accepted.
