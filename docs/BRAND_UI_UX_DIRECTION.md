...
## 3. Professional-tool reference — Festool / Festo

A useful reference point for the desired emotional and systemic character is the professional-tool / industrial-engineering world represented by **Festool** and, in a more industrial-automation sense, **Festo**.

This is a **reference for qualities, not a direction to imitate their visual identity**.

The relevant qualities are:

- professional competence that is immediately legible;
- confidence without aggression;
- engineering precision;
- functional clarity;
- strong product hierarchy;
- disciplined system thinking;
- high perceived quality created through execution rather than decoration;
- recognizable design language across many different tools/components;
- the feeling that each individual surface belongs to one coherent technical ecosystem.

Festool is the closer reference for the desired combination of premium professional-tool character, usability, consistency and restrained strength. Festo is a useful secondary reference for industrial precision, automation, engineering confidence and system architecture.

HullQ should aim for an analogous product impression in software:

```text
Festool/Festo world                 HullQ world
────────────────────────────────────────────────────────
professional instrument            technical search tool
system of compatible tools         coherent data/search system
precise controls                    precise filters/query semantics
clear functional hierarchy         clear information hierarchy
engineering confidence             epistemic/data confidence
recognizable product language      consistent HullQ CI/UI language
quality visible in use              strength demonstrated by UX
```

The intended lesson is:

> **Dominance should emerge from capability, system coherence and quality — not from aggressive styling.**

This reference must not lead to copying Festool/Festo colors, typography, logos, component shapes or other protected/distinctive brand assets. HullQ requires its own independent identity.
...
## 5. UX should express the same strength
...
## 8. Relationship to subjective boat categories
...
## 10. Accessibility and usability guardrail
